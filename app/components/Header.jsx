...
>
  067 900 92 42
        ...
        <div className="hidden lg:flex gap-4 text-lg">
          <a href="https://www.instagram.com/reels_studio_kyiv/" target="_blank" rel="noopener noreferrer" className='text-white hover:opacity-50 opacity-100 '>
            <FaInstagram/>
          </a>
          <a href="https://t.me/golovaschuck_o" target="_blank" rel="noopener noreferrer" className='text-white hover:opacity-50 opacity-100 '>
            <FaTelegram/>
          </a>
        </div>
        ...
        <div className="lg:hidden">
          <button id="ut-open-mobile-menu" className="w-8 h-8 flex flex-col justify-between items-center">
      ...
      <nav className="lg:hidden bg-white shadow-md">
        <ul className="flex flex-col p-4 space-y-2">
          <li><a href="https://am.net.ua/studio/reels/#podcast">Локації для подкасту</a></li>
          <li><a href="https://am.net.ua/studio/reels/#section1">Вартість</a></li>
        </ul>
      </nav>
    </header>
  );
